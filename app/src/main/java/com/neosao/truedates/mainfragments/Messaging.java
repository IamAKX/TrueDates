...
public class Messaging extends Fragment  implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootLayout =  inflater.inflate(R.layout.fragment_messaging, container, false);
        mContext = getContext();
