...
public class FeedFragment extends Fragment {
    ...
    private String[] matchNames = {"Wonder Women", "Black Widow", "Gamora", "Scarlet Witch", "Captain Marvel"};
    private String[] matchLocations = {"3 km", "18 km", "less than a km", "4 km", "6 km"};
