...
public class SliderAdapterPackage extends SliderViewAdapter<SliderAdapterPackage.SliderAdapterVH> {

    private Context context;
    private ArrayList<FeatureSliderModel> list;

    public SliderAdapterPackage(Context context, ArrayList<FeatureSliderModel> list) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_layout_slider2, null);
